...
#ifndef CONTROLLERS_APIS_CONTROLLER_H
#define CONTROLLERS_APIS_CONTROLLER_H
...
/**
 * @class Controller
 * it's a a parent which is herited by all controllers
 * TODO: should be inherited from a generics "controller" that will play the
 *  role of interface
